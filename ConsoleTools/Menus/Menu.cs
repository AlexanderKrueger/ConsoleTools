...
namespace ConsoleTools
{
    namespace Menus
    {
        public abstract class Menu
        {
            ...
            /// is placed at the same index, but in List 'MenuGlobal' (contains all actions in a 'Menu' object).
            /// </summary>
            ...
            /// </remarks>
            protected abstract void WriteMenu(int oldSelectedIndex = -1, int curSelectedIndex = -1);
            ...
            public abstract class MenuThing
            {
                ...
                public string Text {
                    ...
                    set {
                        _Text = value;
                        _TotalNewLines = CountNewLines();
                    }
                }
                private int _TotalNewLines = 0;
                /// <summary>
                /// Total new line characters in text.
                /// </summary>
                public int TotalNewLines { get { return _TotalNewLines; } }
                /// <summary>
                /// Action performed if menu thing is selected in the menu.
                /// </summary>
                public Action Action;
                /// <summary>
                /// Starting line of console buffer (starting buffer line) where first line of MenuThing.Text is written.
                /// </summary>
                //private int BufferLineStart = 0;
                /// <summary>
                /// Ending line of console buffer (ending buffer line) where last line of MenuThing.Text is written.
                /// If MenuThing.Text is single line, then it's equivalent to BufferLineStart.
                /// </summary>
                /// <seealso cref="BufferLineStart"/>
                //private int BufferLineEnd = 0;
                
                /// <summary>
                /// Counts the total new line characters in the instance's Text value.
                /// </summary>
            ...
            public class MenuBar : MenuThing
            {
                ...
                public static string DefaultBar
                {
                    get
                    {
                        if (_DefaultBarValue != DEFAULT_BAR
