...
namespace ConsoleTools
{
    namespace Menus
    {
        ...
        public sealed class SelectorMenu : Menu
        {
            ...
            /// <summary>
            /// Index of menu item in MenuGlobal the selector is on. It does NOT
            /// indicate the console buffer line(s) the item is written to.
            /// </summary>
            /// <example>
            ...
            /// </summary>
            private readonly ConsoleColor MenuBackgroundColor = ConsoleColor.Black;
            /// <summary>
            /// Foreground (text) color of the 'SelectorMenu' object.
            /// </summary>
            private readonly ConsoleColor MenuForegroundColor = ConsoleColor.White;
            ...
            /// </summary>
            override protected void WriteMenu(int oldSelectedIndex = -1, int curSelectedIndex = -1)
            {
                //Put cursor to start
                ...
                {
                    //*** Menu Needs A Discrete Write ***
                    //***********************************
                    //If the menu need not to be written whole a
                    if (curSelectedIndex > -1)
                    {
                        //If menuThing is the old menu item, then...
                        if (iterator == curSelectedIndex) {
                            //*** Write Selected Menu Item As Highlighted ***
                        ...
                        //Else if menuThing is currently selected menu item, then...
                        else if(iterator == oldSelectedIndex)
                        {
                            //*** Write Old Selected Menu Item As Not Highlighted ***
                            Console.WriteLine(Selector.SelectorStrPlaceholder + menuThing.Text + Selector.SelectorStrPlaceholder);
                        }
                        //Else if menuThing is neither menu item, then...
                        else if (iterator != oldSelectedIndex && iterator != curSelectedIndex)
                        {
                            //*** Advance The Console Cursor After The Menu Item ***
                            Console.CursorTop += this.MenuGlobal[iterator].TotalNewLines + 1;
                        }
                    ...
                    //If menu thing is bar (not menu item)...
            ...
            /// </summary>
            private void RunMenu(ref int oldSelectedIndex, ref int curSelectedIndex)
            {
                Console.CursorVisible = false;
                WriteMenu(oldSelectedIndex, curSelectedIndex);
                PromptNav();
            }
        ...
        public class Selector
        {
            ...
            private static string BuildSelectorPlaceholder(string selectorStr)
            {
                ...
                int loops = (new System.Globalization.StringInfo(selectorStr)).LengthInTextElements;
